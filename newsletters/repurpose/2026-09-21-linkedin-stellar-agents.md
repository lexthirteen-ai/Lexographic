...
6. You carry the staged file across into the real tool yourself.

And the part I'd steal first if I were you:

**SENT is not on the map.** The pipeline ends at STAGED. Every agent stops one step before the consequence, and a person walks it across.
